---
title: 100x Aggregates — making aggregation faster
description: How we replaced Python-materialised aggregates with native methods and saw 10–100x speedups.
date: 2026-05-02
author: Justin Joyce
...
As we're working through refactoring [Opteryx](https://opteryx.app/) as we remove Arrow, the first pass was 'get it to work'; we're now looking at performance stats and seeing where working isn't good enough. 
