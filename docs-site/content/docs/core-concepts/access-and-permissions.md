...
Policies and ACLs can be managed via the Policy API (see [Policy API](/docs/reference/api/policy-api)). The Policy API accepts JSON policy documents describing principals, resources and allowed actions.
