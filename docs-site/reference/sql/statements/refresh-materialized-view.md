...
- rebuilding after a refresh failed (a permissions problem, an
  [egress protection](alter-workspace#egress-protection) refusal) once the cause is fixed
...
- Subject to [egress protection](alter-workspace#egress-protection) like any other write:
