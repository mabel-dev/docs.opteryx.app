...
API_DOC_SPECS = {
    'api-opteryx-control.json': {
        ...
        'summary': 'Billing accounts and membership, payment methods and invoices, workspace lifecycle and catalogs, and the notification feed behind the Studio bell. Access policies are granted in SQL rather than here \u2014 see GRANT and REVOKE.',
        'try_it_live': True,
    },
